...
if ($_POST) {
    $car_id = $Car->createCar($_POST['owner'], $_POST['make'], $_POST['reg_no'], $_POST['body_type'], $_POST['capacity'], $_POST['lease_start'], ($_POST['lease_end'] ? $_POST['lease_end']: null) );
    $user_log->info("User has created car ID" .$car_id);
